...
using static Mango.Service.Identity.Pages.Account.Register.RegisterViewModel;
    ...
    public class Index : PageModel
    {
        ...
        private async Task BuildRegisterViewModelAsync(string returnUrl)
        {
            ...
            if (context?.IdP != null && await _schemeProvider.GetSchemeAsync(context.IdP) != null)
            {
                ...
                if (!local)
                {
                    View.ExternalProviders = new[] { new RegisterViewModel.ExternalProvider { AuthenticationScheme = context.IdP } };
                }
